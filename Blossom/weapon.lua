...
function Weapon:updateAim()
  ...
  -- something from muro 
  -- if you set aimDirection in the json stance as 1 it'll make your char just face the way it would already
  -- -1 inverts the way they're facing 
  -- also it defaults to 1, so you don't have to set it in every stance after making that change
  -- activeItem.setFacingDirection(self.aimDirection * (self.stance.aimDirection or 1))
  self.stance.aimDirection = self.stance.aimDirection or 1
  activeItem.setFacingDirection(self.aimDirection * (flipping and -self.stance.aimDirection or self.stance.aimDirection))
